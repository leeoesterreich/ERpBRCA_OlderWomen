...
# one cell type per cluster - similar to the original analysis
...
# -----------------------------------------------------------------------------
# Step 7: Compare with original cluster assignments
# -----------------------------------------------------------------------------
cat("\nStep 7: Comparison with original analysis...\n")

# Original assignments for 40 clusters (resolution 1.5)
