...
# Override via environment variable NEIL_PROJECT_DIR if needed
_NEIL_PROJECT = os.environ.get(
    "NEIL_PROJECT_DIR",
    "data/external/NeilOrganoidSingleCell",
)

_LAB_DATA_DIR = os.environ.get(
    "LAB_DATA_DIR",
    "data/external/20260304_NeilOrganoidSingleCell_Alex",
)
...
DATA_PATHS = {
    ...
    "fastqs_pool1": f"{_LAB_DATA_DIR}/Lee_020326_AL1_FlexPool_1_OES9112A1",
    "fastqs_pool2": f"{_LAB_DATA_DIR}/Lee_020326_AL1_FlexPool_2_OES9112A2",
