...
#
# Inputs:
#   - ${XU_ATLAS_DIR}/matrix.mtx
#   - ${XU_ATLAS_DIR}/genes.tsv
#   - ${XU_ATLAS_DIR}/barcodes.tsv
#   - ${XU_ATLAS_DIR}/metadata.csv
#
# Outputs:
...
raw_data_dir <- Sys.getenv("XU_ATLAS_DIR", unset = file.path(project_root, "data", "external", "Xu_etal_Primary_Breast_Tumor_Atlas_2024"))
